...
> **Notice:**
> 1. The bam directory contains BAM files for each sample. Each BAM file was generated by aligning the
     > resequencing reads of the corresponding sample to the reference genome.
     > Index files (.bai) are required for all BAM files.
> 2. Sample names must not contain any periods (".").
